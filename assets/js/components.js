      ...
      <div class="container">
        <div class="glass-nav-bubble d-flex align-items-center justify-content-between">
          ...
          <nav id="navmenu" class="navmenu">
            <div class="mobile-drawer-card d-xl-none">
              <div class="mobile-drawer-header">
                <div class="d-flex align-items-center gap-2">
                  <img src="assets/assets/ACE VET CARE.png" alt="Logo" width="34" height="34">
                  <div>
              ...
              <div class="mobile-drawer-actions">
                ...
                <a href="https://wa.me/254703824551?text=Hello%20Ace%20Vet%20Care" target="_blank" class="btn btn-success rounded-pill w-100 py-2 fw-semibold"><i class="bi bi-whatsapp me-2"></i> WhatsApp Chat</a>
                <div class="emergency-badge mt-2 text-center">
                  <span class="badge bg-danger bg-opacity-10 text-danger border border-danger border-opacity-25 rounded-pill px-3 py-2 w-100 d-block">
                    <i class="bi bi-telephone-fill me-1"></i> 24/7 Emergency: +254 703 824 551
                  </span>
                </div>
              </div>
            </div>
            <ul class="desktop-nav-list d-none d-xl-flex">
          ...
          <div class="d-flex align-items-center gap-2">
            ...
            <button type="button" class="mobile-nav-toggle d-xl-none" aria-label="Toggle Navigation">
      ...
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-about">
          ...
          <div class="social-links d-flex mt-4">
            ...
            <a href="http://tiktok.com/@acevetkenya" aria-label="TikTok"><i class="bi bi-tiktok"></i></a>
            <a href="https://wa.me/254703824551" aria-label="WhatsApp"><i class="bi bi-whatsapp"></i></a>
          </div>
        </div>
...
function initializeHeaderScripts() {
    ...
    function closeMobileNav() {
        ...
        if (mobileNavToggleBtn) {
            mobileNavToggleBtn.classList.remove('active');
        }
    }
    ...
    if (mobileDrawerCloseBtn) {
        mobileDrawerCloseBtn.addEventListener('click', function (e) {
            e.stopPropagation();
            closeMobileNav();
        });
    }
    ...
    // Close when clicking outside the drawer menu
    document.addEventListener('click', function (e) {
        if (body.classList.contains('mobile-nav-active')) {
            const navmenu = document.querySelector('#navmenu');
            if (navmenu && !navmenu.contains(e.target) && !mobileNavToggleBtn.contains(e.target)) {
                closeMobileNav();
            }
        }
    });
